...
% ==========================================
\section{Pradiniai įrankiai: kodėl veikia dalumo požymiai?}
...
\begin{proposition}[Dalumo iš 9 ir iš 3 požymis]
Triženklis skaičius $\overline{abc}$ dalijasi iš $9$ (atitinkamai iš $3$) tada ir tik tada, kai jo skaitmenų suma $a+b+c$ dalijasi iš $9$ (atitinkamai iš $3$).
\end{proposition}
...
\begin{remark*}
Šio triuko esmė: kiekvieną dešimtainio užrašo vietą pakeičiame skaičiumi, kuris nuo 1 skiriasi devyneto kartotiniu. Tada visas „sunkus“ dalumas lieka skaitmenų sumai.
\end{remark*}
...
\begin{proposition}[Dalumo iš 11 požymis]
Keturaženklis skaičius $\overline{abcd}$ dalijasi iš $11$ tada ir tik tada, kai kaitaliojamų ženklų skaitmenų suma $a-b+c-d$ dalijasi iš $11$.
\end{proposition}

\begin{proof}
Pabandykime jį sukonstruoti taip pat, kaip darėme su devynetu. Paimkime keturaženklį $\overline{abcd}$. 
...
\begin{remark*}
Kai matome dalumą iš $11$, verta iš karto tikrinti kaitaliojamų ženklų sumą. Tai dažnai leidžia išvengti ilgo skaičiaus dauginimo.
\end{remark*}
...
$a - b + b - a = 0$. Kadangi $11 \mid 0$, skaičius visada dalijasi iš 11.
\end{proof}
...
Tuomet $x = 12 - 9 = 3$.
Pradinis skaičius buvo $39$ (galime patikrinti: $93 - 39 = 54$).
\end{proof}
...
\end{itemize}
Atsakymas: Skaičiai gali būti $5670$ ir $5175$.
\end{proof}
