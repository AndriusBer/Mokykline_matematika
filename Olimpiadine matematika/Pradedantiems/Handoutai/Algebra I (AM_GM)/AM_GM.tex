...
% ==========================================
\newpage
\section{Uždaviniai savarankiškam sprendimui (35 iššūkiai)}
...
\begin{enumerate}
    ...
    \item Įrodykite, kad bet kokiems realiesiems skaičiams $a$ ir $b$ teisinga nelygybė:
    $$ a(a-b) \ge b(a-b) $$

    \item Įrodykite, kad teigiamiems realiesiems skaičiams $a$ teisinga nelygybė:
    $$ a - 1 \ge 1 - \frac{1}{a} $$

    \item Įrodykite, kad teigiamiems realiesiems skaičiams $a$ ir $b$ teisinga nelygybė:
    $$ \frac{a^2}{b} \ge 2a - b $$

    \item Įrodykite, kad teigiamiems realiesiems skaičiams $a$ ir $b$ teisinga nelygybė:
    $$ \frac{a^2}{b} \ge a - \frac{b}{4} $$
    ...
    \item Įrodykite, kad teigiamiems skaičiams $a$ ir $b$ teisinga nelygybė:
...
\begin{enumerate}
    ...
    \item Įrodykite, kad neneigiamiems skaičiams $a, b$ ir $c$ teisinga nelygybė:
    $$ a^3+b^3+c^3 \ge 3abc $$
    ...
    \item Įrodykite, kad teigiamiems skaičiams $x$ ir $y$ galioja nelygybė:
    $$ (x+y)(x^2+y^2)(x^3+y^3) \ge 8x^3y^3 $$

    \item Įrodykite, kad neneigiamiems skaičiams $a, b$ ir $c$ teisinga nelygybė:
    $$ (a+b+c)(a^2+b^2+c^2) \ge 9abc $$

    \item Įrodykite, kad neneigiamiems skaičiams $a, b, c$ ir $d$ galioja nelygybė:
    $$ (a+b+c+d)(a^3+b^3+c^3+d^3) \ge 16abcd $$

    \item Įrodykite, kad teigiamiems skaičiams $a, b$ ir $c$ teisinga nelygybė:
    $$ (a+b+c)\left(\frac{1}{a}+\frac{1}{b}+\frac{1}{c}\right) \ge 9 $$

    \item Įrodykite, kad bet kokiems realiesiems skaičiams $a, b$ ir $c$ teisinga nelygybė:
    $$ (a+b+c)^2 \le 3(a^2+b^2+c^2) $$

    \item Įrodykite, kad bet kokiems realiesiems skaičiams $a, b, c$ ir $d$ teisinga nelygybė:
...
\begin{enumerate}
    ...
    \item Įrodykite, kad neneigiamiems skaičiams $a, b$ ir $c$ galioja nelygybė:
    $$ 3(a^3+b^3+c^3) \ge (a+b+c)(a^2+b^2+c^2) $$

    \item Įrodykite, kad neneigiamiems skaičiams $a$ ir $b$ galioja nelygybė:
    $$ (a+b)(a^4+b^4) \ge (a^2+b^2)(a^3+b^3) $$

    \item Įrodykite, kad neneigiamiems skaičiams $a, b$ ir $c$ teisinga nelygybė:
    $$ a^5+b^5+c^5 \ge abc(a^2+b^2+c^2) $$

    \item Įrodykite, kad teigiamiems skaičiams $a, b$ ir $c$ teisinga nelygybė:
    $$ \frac{2}{b+c}+\frac{2}{c+a}+\frac{2}{a+b} \ge \frac{9}{a+b+c} $$

    \item \textbf{(Nesbito nelygybė)} Įrodykite legendinę olimpiadinę nelygybę bet kokiems teigiamiems $a, b, c$:
    ...
    \item Įrodykite, kad teigiamiems realiesiems skaičiams $a, b$ ir natūraliesiems skaičiams $n, k$ ($n>1$) teisinga nelygybė:
    $$ a^n+b^n \ge a^{n-k}b^k+a^kb^{n-k} $$

    \item Įrodykite, kad teigiamiems skaičiams $a_1, a_2, \dots, a_n$ teisinga nelygybė:
    $$ (a_1+a_2+\dots+a_n)\left(\frac{1}{a_1}+\frac{1}{a_2}+\dots+\frac{1}{a_n}\right) \ge n^2 $$

    \item Įrodykite, kad bet kokiems realiesiems skaičiams $a_1, a_2, \dots, a_n$ teisinga nelygybė:
