...
Jei skaičiuosite diskriminantą, gausite $D = 36 - 8 = 28$. Šaknys bus negražios: $x_1 = \frac{6 - \sqrt{28}}{2}$ ir $x_2 = \frac{6 + \sqrt{28}}{2}$. Kelti tokius monstrus kvadratu ir juos sudėti yra daug energijos kainuojantis darbas, kuriame labai lengva padaryti klaidą.
...
\[ x_1^2 + x_2^2 = 6^2 - 2 \cdot 2 = 36 - 4 = \mathbf{32} \]
...
\begin{enumerate}
    \item $x_1 + x_2 = 7$; $x_1 x_2 = 10$.
    \item $x_1 + x_2 = -4$; $x_1 x_2 = -2.5$.
    \item $x_1 + x_2 = 4$; $x_1 x_2 = 0$.
    \item $-12$
    \item $73$
    \item $\frac{2}{3}$
    \item $15$
    \item $17$
    \item $10.5$ (arba $\frac{21}{2}$)
    \item $95$
    \item $-6$
    \item $52$
    \item $x^2 - 6x + 4 = 0$
    ...
    \item $29$
    \item $47$
    \item $m = 1$; minimali suma lygi $2$.
    \item Įrodymas atliekamas pritaikant Vijetą: pirmoje lygtyje suma lygi $-p$, antroje $p$, jų bendra suma lygi $0$. Ieškomo reiškinio reikšmė yra $-4q$.
\end{enumerate}
