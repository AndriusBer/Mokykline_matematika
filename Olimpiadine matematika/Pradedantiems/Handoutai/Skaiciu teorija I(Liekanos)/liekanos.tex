...
\title{Skaičių teorija: Dalyba su liekana ir skaičių ciklai}
...
\begin{example}[Ciklas, kurio ilgis nėra $4$]
Raskite paskutinį skaičiaus \(9^{2026}\) skaitmenį.
\end{example}

\begin{proof}
Stebime pirmuosius laipsnius:
\[
9^1=9,\qquad 9^2=81,
\]
taigi paskutiniai skaitmenys kartojasi ciklu $9,1$. Ciklo ilgis yra $2$. Kadangi
\[
2026=2\cdot 1013,
\]
rodiklis atitinka antrąją ciklo vietą. Vadinasi, skaičiaus \(9^{2026}\) paskutinis skaitmuo yra $1$.
\end{proof}
...
\begin{example}[Liekanos išvedimas algebriškai]
Įrodykite, kad bet kokio nelyginio skaičiaus kvadratą padalijus iš $8$, liekana visada bus lygi $1$.
\end{example}
