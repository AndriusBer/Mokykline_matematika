...
Uždavinių pavyzdžiai ir jų sprendimai privalo būti išskirti į dvi atskiras aplinkas: sąlyga rašoma `example` aplinkoje, o sprendimas – po jos sekančioje `solution` aplinkoje. Žodis „Atsakymas:“ sprendimo pabaigoje yra privalomas.
...
Žemiau pateikiamas idealiai suformatuotas dokumento pavyzdys (su `example` ir `solution` atskyrimu), į kurį AI turi lygiuotis.

### Pavyzdys: Pilnojo kvadrato išskyrimas
