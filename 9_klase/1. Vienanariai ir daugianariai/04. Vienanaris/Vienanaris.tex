...
\begin{definition}
\vocab{Vienanaris} -- tai skaičiaus ir kintamųjų, pakeltų neneigiamaisiais sveikaisiais laipsniais, sandauga.
...
\begin{remark}
Skaičius $8$ yra vienanaris, nes jį galima užrašyti kaip:
\[
8=8x^0,
\]
o $x^0=1$.
