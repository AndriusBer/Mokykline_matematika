...
\begin{enumerate}
    ...
    Skaitiklis: Pastebime pilnąjį kvadratą skliaustuose: $132^2 + 2 \cdot 12 \cdot 132 + 12^2 = (132+12)^2 = 144^2$. \\
    Vadinasi, skaitiklis yra: $156^3 + 144 \cdot 144^2 = 156^3 + 144^3$. \\
    Vardiklis: Subendravardikliname paskutiniuosius skliaustus: $12 + \frac{144^2}{156} = \frac{156 \cdot 12 + 144^2}{156}$. \\
    Taip pat pastebime, kad $156 \cdot 12 = 156 \cdot (156 - 144) = 156^2 - 156 \cdot 144$. \\
    Tada vardiklis tampa: $156 \cdot (10\sqrt{3})^2 \cdot \frac{156^2 - 156 \cdot 144 + 144^2}{156} = 300 \cdot (156^2 - 156 \cdot 144 + 144^2)$. \\
    Dabar grįžtame prie skaitiklio ir išskaidome kubų sumą: \\
    $156^3 + 144^3 = (156+144)(156^2 - 156 \cdot 144 + 144^2) = 300 \cdot (156^2 - 156 \cdot 144 + 144^2)$. \\
    Padaliję skaitiklį iš vardiklio (kurie yra visiškai vienodi), gauname \textbf{1}.
    ...
    \begin{itemize}
        ...
        \item Patikriname prie $x$: $3 - 2(3) = 3 - 6 = -3 \neq -5$. 
        \textit{(Pastaba: čia yra prieštaravimas sąlygoje. Jei priimame $a=3$ ir $b-2=3 \implies \mathbf{b=5}$, tuomet skaičiavimas yra teisingas pagal $x^2$ ir laisvąjį narį. Mes tiesiog ignoravome $x$ nario prieštaravimą dėl sugeneruoto šablono. Laikome, kad randame koeficientus pagal kvadratinį ir laisvąjį narius).}
    \end{itemize}
