...
\runningheadrule
\firstpageheader{Vardas: \rule{4cm}{0.4pt}}{Kontrolinis darbas: \\Daugianariai}{Euklido variantas}
...
\question[5]  Reiškinį $(x+2) ^{3} -(x+4) ^{2} (x+2)$ užrašę pavidalu $a(x+b)^{2} + c$ apskaičiuote reiškinio $\sqrt{-a+4b+c+1} $ reikšmę.   
\droppoints
\vspace{3.5cm}
\atsakymas

\question[4] Raskite tokias parametrų $a$, $b$ ir $c$ reikšmes, kad lygybė $(ax+b)(x^2-x+2) + cx = 3x^3-5x^2+5x-4$ būtų teisinga su visomis $x$ reikšmėmis.
\droppoints
\vspace{4.5cm}
\atsakymas
