...
\begin{tasks}[label={(\arabic*)}, label-offset=0.9em](1)
    \task racionalus, sveikas, daugianaris.
    \task iracionalus (kintamieji po šaknimi).
    \task racionalus, sveikas, vienanaris (galima užrašyti $\frac{7}{3} \cdot x$).
    \task racionalus, trupmeninis (kintamasis vardiklyje).
    \task racionalus, sveikas, vienanaris.
    \task racionalus, sveikas, daugianaris.
    \task racionalus, sveikas, daugianaris (po šaknimi tik skaičius).
    ...
    \task racionalus, sveikas, daugianaris (išskleidus gaunama vienanarių suma).
    \task racionalus, sveikas, vienanaris.
    \task racionalus, sveikas, daugianaris.
    \task racionalus, sveikas, daugianaris.
    \task racionalus, trupmeninis.
