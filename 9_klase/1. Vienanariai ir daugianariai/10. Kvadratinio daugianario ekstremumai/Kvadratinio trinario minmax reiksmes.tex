...
\begin{definition}
\vocab{Kvadratinio daugianario mažiausia reikšmė} -- tai mažiausia reikšmė, kurią gali įgyti reiškinys, kai $x$ įgyja visas galimas reikšmes.
\end{definition}

\begin{definition}
\vocab{Kvadratinio daugianario didžiausia reikšmė} -- tai didžiausia reikšmė, kurią gali įgyti reiškinys.
\end{definition}
...
Pavidalu $ax^2+bx+c$ mažiausios reikšmės iš karto nustatyti nemokame. Todėl pirmiausia išskiriame pilnąjį kvadratą ir reiškinį suvedame į formą $a(x-m)^2+n$, kurią jau mokame nagrinėti.
...
\]
\textbf{Sprendimas}\\
Reiškinys jau pateiktas forma $a(x-m)^2+n$, kur $a=2>0$, $m=3$, $n=-5$. Todėl mažiausia reikšmė yra $-5$. Ji pasiekiama, kai $x-3=0$, t. y. kai $x=3$.\\ \\
\textbf{Atsakymas:} mažiausia reikšmė yra $-5$, ji pasiekiama, kai $x=3$.
\end{example}
...
Pavidalu $ax^2+bx+c$ didžiausios reikšmės iš karto nustatyti nemokame. Todėl pirmiausia išskiriame pilnąjį kvadratą ir reiškinį suvedame į formą $-a(x-m)^2+n$, kurią jau mokame nagrinėti.
...
\]
\textbf{Sprendimas}\\
Reiškinys jau pateiktas forma $-a(x-m)^2+n$, kur $a=2>0$, $m=-1$, $n=6$. Todėl didžiausia reikšmė yra $6$. Ji pasiekiama, kai $x+1=0$, t. y. kai $x=-1$.\\ \\
\textbf{Atsakymas:} didžiausia reikšmė yra $6$, ji pasiekiama, kai $x=-1$.
\end{example}
...
\begin{problem}
Nustatykite reiškinio mažiausią arba didžiausią reikšmę ir nurodykite, su kuria $x$ reikšme ji pasiekiama.
\begin{tasks}[label={(\arabic*)}, label-offset=0.9em](2)
	\task $2(x-3)^2-5$
	\task $-(x+1)^2+4$
	\task $3(x+2)^2+1$
	\task $-2(x-4)^2-3$
	\task $\frac{1}{2}(x-5)^2-7$
	\task $-4(x-2)^2+9$
	\task $5(x+3)^2+2$
	\task $-(x-6)^2-1$
	\task $\frac{1}{3}(x+1)^2+8$
	\task $-3(x+5)^2+6$
\end{tasks}
\end{problem}

\begin{problem}
Išskirdami pilnąjį kvadratą raskite reiškinio ekstremumus ir nurodykite, su kuria $x$ reikšme ji pasiekiama.
\begin{tasks}[label={(\arabic*)}, label-offset=0.9em](2)
	\task $x^2-10x+4$
	\task $x^2+2x-8$
	\task $-x^2-6x+2$
...
\begin{tasks}[label={(\arabic*)}, label-offset=0.9em](2)
\task mažiausia reikšmė $-5$, kai $x=3$;
\task didžiausia reikšmė $4$, kai $x=-1$;
\task mažiausia reikšmė $1$, kai $x=-2$;
\task didžiausia reikšmė $-3$, kai $x=4$;
\task mažiausia reikšmė $-7$, kai $x=5$;
\task didžiausia reikšmė $9$, kai $x=2$;
\task mažiausia reikšmė $2$, kai $x=-3$;
\task didžiausia reikšmė $-1$, kai $x=6$;
\task mažiausia reikšmė $8$, kai $x=-1$;
\task didžiausia reikšmė $6$, kai $x=-5$.
\end{tasks}
\end{problem}
...
\begin{tasks}[label={(\arabic*)}, label-offset=0.9em](2)
	...
	\task mažiausia reikšmė $-\frac{17}{8}$, kai $x=-\frac{3}{4}$;
	\task didžiausia reikšmė $\frac{49}{12}$, kai $x=\frac{5}{6}$;
	\task mažiausia reikšmė $-\frac{33}{16}$, kai $x=\frac{7}{8}$;
	\task didžiausia reikšmė $\frac{49}{8}$, kai $x=-\frac{3}{4}$.
\end{tasks}
\end{problem}
...
\begin{tasks}[label={(\arabic*)}, label-offset=0.9em](2)
	...
	\task mažiausia reikšmė $-\frac{49}{12}$, kai $x=-\frac{5}{6}$;
	\task didžiausia reikšmė $\frac{65}{16}$, kai $x=\frac{7}{8}$;
	\task mažiausia reikšmė $\frac{23}{8}$, kai $x=\frac{3}{4}$;
	\task didžiausia reikšmė $\frac{121}{20}$, kai $x=-\frac{9}{10}$.
\end{tasks}
\end{problem}
