...
\begin{tasks}[resume, label={(\arabic*)}, label-offset=0.9em](2)
    \task $4 x(x+3)=12 x+1$
    \task $3 m=m\left(m+2 \frac{1}{3}\right)$
    \task $a(6 a+1)=2 a\left(2-2 \frac{1}{2} a\right)$
    \task $3\left(1-5 k^2\right)=2\left(1-6 k^2\right)$
    \task $(2 p-3)(2 p+3)=7$
    \task $(3 y+2)^2=4(y+1)$
    \task $(7 x-2)(x+2)=(3 x-1)(3 x+5)$
    \task $\left(\frac{1}{2} m+4\right)(2 m-4)=3 m(m+2)-16$
\end{tasks}


\begin{tasks}[resume, label={(\arabic*)}, label-offset=0.9em](2)
    \task $6 m^2-(2 m-1)^2=m(m+4)$
    \task $(3 a+1)^2-10=(a+3)(a-3)$
    \task $(4 x-3)^2-(3 x-4)^2=7$
    \task $10 m+(2-m)^2=63-(3-m)^2$
    \task $(2 p+3)^2+(2 p-3)^2+(p-6)(p+6)=p^2$
    \task $(x+4)(x+3)+(x-2)(x+2)=2(3 x+4)$
\end{tasks}
\end{problem}
...
\begin{problem} \phantom{text}
\begin{tasks}[resume, label={(\arabic*)}, label-offset=0.9em](2)
    \task $x=-\frac{1}{2}$, $x=\frac{1}{2}$
    \task $m=0$, $m=\frac{2}{3}$
    \task $a=0$, $a=\frac{3}{11}$
    \task $k=-\frac{\sqrt{3}}{3}$, $k=\frac{\sqrt{3}}{3}$
    \task $p=-2$, $p=2$
    \task $y=-\frac{8}{9}$, $y=0$
    \task $x=-\frac{\sqrt{2}}{2}$, $x=\frac{\sqrt{2}}{2}$
    \task $m=0$
\end{tasks}
...
\begin{tasks}[resume, label={(\arabic*)}, label-offset=0.9em](2)
    \task $m=-1$, $m=1$
    \task $a=-\frac{3}{4}$, $a=0$
    \task $x=-\sqrt{2}$, $x=\sqrt{2}$
    \task $m=-5$, $m=5$
    \task $p=-\frac{3}{2}$, $p=\frac{3}{2}$
    \task $x=-\frac{1}{2}$, $x=0$
\end{tasks}
\end{problem}
