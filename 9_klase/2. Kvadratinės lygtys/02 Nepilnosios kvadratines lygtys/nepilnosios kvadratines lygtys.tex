...
Jei lygtyje koeficientas $b=0$ arba $c=0$, tokia lygtis vadinama \textbf{nepilnąja kvadratine lygtimi}[cite: 2]. Šiame skyriuje nagrinėsime abiejų tipų nepilnąsias lygtis: kai $b=0$ (lygtys pavidalo $ax^2+c=0$) ir kai $c=0$ (lygtys pavidalo $ax^2+bx=0$)[cite: 2].
