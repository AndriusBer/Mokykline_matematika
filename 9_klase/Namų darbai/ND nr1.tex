...
\begin{enumerate}[label=\textbf{\arabic* užduotis.}, leftmargin=*]
    ...
    \[
    \frac{(4x - 1)(2x + 3) - 2(x - 2)^2 - (3x - 1)(3x + 1) + 3\left(x^2 + 3\frac{1}{3}\right)}{(3x + 1)(2x + 5) - 2(x + 2)^2 - (2x - 1)(2x + 1) + 2}
    \]
    ...
    % 7 lygis: Sumos ir skirtumo kubo formulės
    \item Atskliauskite, taikydami sumos arba skirtumo kubo formulę:
    \begin{center}
        \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lll@{}}
            a) $(2x + 3)^3$ & b) $(4x - 1)^3$ & c) $(5x + 2)^3$ \\
            d) $(3x - 10)^3$ & e) $(x + 4)^3$ & f) $(x - 5)^3$
        \end{tabular*}
    \end{center}
\end{enumerate}
...
\begin{enumerate}[label=\textbf{\arabic* užduotis.}, leftmargin=*]
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item $64x^3 - 48x^2 + 12x - 1$
        \item $125x^3 + 150x^2 + 60x + 8$
        \item $27x^3 - 270x^2 + 900x - 1000$
        \item $x^3 + 12x^2 + 48x + 64$
        \item $x^3 - 15x^2 + 75x - 125$
    \end{enumerate}
\end{enumerate}
